...
parser = argparse.ArgumentParser(description="hyper-parameter for R2Gen-EVA")
# ========================= Dataset Configs ==========================
...
parser.add_argument('--annotation', type=str, default='/home/guest/czl/dataset/iu_xray/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default='/home/guest/czl/dataset/iu_xray/images', help="base dir to help find images")
parser.add_argument('--batch_size', default=6, type=int, help="use for training duration per worker")
parser.add_argument('--val_batch_size', default=6, type=int, help="use for validation duration per worker")
parser.add_argument('--test_batch_size', default=12, type=int, help="use for testing duration per worker")
...
parser.add_argument('--base', default='configs/custom_vqgan.yaml', type=str, help="paths to base configs. Loaded from left-to-right.")

# ========================= Model Settings ============================
parser.add_argument('--vision_model', default='/home/guest/czl/pretrained_models/swin_transformer', type=str, help="vision model to use  swin-base-patch4-window7-224")
parser.add_argument('--llama_model', default='/home/guest/czl/pretrained_models/llama-2-7b-chat-hf', type=str, help="LLM model to use  Llama-2-7b-chat-hf")
parser.add_argument('--projector', default='mlp', type=str, help='mlp or fc')
...
# ======================== SavedModel Configs ===========================
parser.add_argument('--savedmodel_path', type=str, default='./save/iu_xray/test')
...
parser.add_argument('--pretrain_file', type=str, default=None, help='the delta file to load')
...
parser.add_argument('--warmup_epochs', type=str, default=3, help='How much epochs to train the model on label classification')
